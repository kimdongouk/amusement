			...
			<div id="carouselExampleInterval" class="carousel slide"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img
							src="https://img.freepik.com/free-photo/nakorn-ratchasrima-thailand-december-13-scenical-world-khao-yai-on-december-13-2016-in-nakorn-ratchasrima-thailand-it-was-built-for-tourist-in-khao-yai-new-point-tourist-attraction-and-check-in_1428-574.jpg?w=1380&t=st=1680262427~exp=1680263027~hmac=9e520de17ecaaf20675ccc06586d899a9c840cbc2043588d37cb8e94406cce6d"
							class="d-block w-100 custom-carousel-img" alt="...">
					</div>
					<div class="carousel-item">
						<img
							src="https://img.freepik.com/free-photo/aerial-drone-view-of-the-big-square-decorated-for-christmas-in-sibiu-romania_1268-19592.jpg?w=1380&t=st=1680262359~exp=1680262959~hmac=c18bce7816e10a2ab52bf9de714159e0b7140131494e82d56ce5d2fbe8728406"
							class="d-block w-100 custom-carousel-img" alt="...">
					</div>
					<div class="carousel-item">
						<img
							src="https://storage.googleapis.com/cdn.media.bluedot.so/bluedot.tappik/2022/08/pexels-craig-adderley-3411132.jpg"
							class="d-block w-100 custom-carousel-img" alt="...">
					</div>
				</div>
				...
				<div class="row g-5 ">
					<div class="col-3">
						<a href="" class="text-decoration-none text-dark ">
							<div class="card shadow-sm">
								<img
									src="https://cdn.pixabay.com/photo/2018/11/20/08/03/castle-3826771_960_720.jpg"
					...
					<div class="col-3">
						<a href="" class="text-decoration-none text-dark ">
							<div class="card shadow-sm">
								<img
									src="https://cdn.pixabay.com/photo/2018/07/21/14/08/entertainment-3552633_960_720.jpg"
									class="custom-card-img" alt="...">
								<div class="card-body custom-card-body-height overflow-hidden">
									<h5 class="card-title">카드 제목</h5>
									<p class="card-text">카드 내용</p>
					...
					<div class="col-3">
						<a href="" class="text-decoration-none text-dark ">
							<div class="card shadow-sm">
								<img
									src="https://cdn.pixabay.com/photo/2020/01/21/16/42/urbex-4783364_960_720.jpg"
									class="custom-card-img" alt="...">
								<div class="card-body custom-card-body-height overflow-hidden">
									<h5 class="card-title">카드 제목</h5>
									<p class="card-text">카드 내용</p>
					...
					<div class="col-3">
						<a href="" class="text-decoration-none text-dark ">
							<div class="card shadow-sm">
								<img
									src="https://cdn.pixabay.com/photo/2016/12/13/17/41/merry-go-round-1904715_960_720.jpg"
									class="custom-card-img" alt="...">
								<div class="card-body custom-card-body-height overflow-hidden">
									<h5 class="card-title">카드 제목</h5>
									<p class="card-text">카드 내용</p>
				...
				<div class="row g-5 ">
					<div class="col-3">
						<a href="" class="text-decoration-none text-dark ">
							<div class="card shadow-sm">
								<img
									src="https://cdn.pixabay.com/photo/2016/09/18/20/34/wyoming-1678957__340.jpg"
									class="custom-card-img" alt="...">
								<div class="card-body custom-card-body-height overflow-hidden">
									<h5 class="card-title">카드 제목</h5>
									<p class="card-text">카드 내용</p>
					...
					<div class="col-3">
						<a href="" class="text-decoration-none text-dark ">
							<div class="card shadow-sm">
								<img
									src="https://cdn.pixabay.com/photo/2015/07/26/20/11/carousel-861705__340.jpg"
									class="custom-card-img" alt="...">
								<div class="card-body custom-card-body-height overflow-hidden">
									<h5 class="card-title">카드 제목</h5>
									<p class="card-text">카드 내용</p>
					...
					<div class="col-3">
						<a href="" class="text-decoration-none text-dark ">
							<div class="card shadow-sm">
								<img
									src="https://cdn.pixabay.com/photo/2018/09/02/17/51/oktoberfest-3649390_960_720.jpg"
									class="custom-card-img" alt="...">
								<div class="card-body custom-card-body-height overflow-hidden">
									<h5 class="card-title">카드 제목</h5>
									<p class="card-text">카드 내용</p>
					...
					<div class="col-3">
						<a href="" class="text-decoration-none text-dark ">
							<div class="card shadow-sm">
								<img
									src="https://cdn.pixabay.com/photo/2014/03/07/09/05/fair-281755__340.jpg"
									class="custom-card-img" alt="...">
								<div class="card-body custom-card-body-height overflow-hidden">
									<h5 class="card-title">카드 제목</h5>
									<p class="card-text">카드 내용</p>
